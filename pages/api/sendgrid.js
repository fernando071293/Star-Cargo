...
async function sendEmail(req, res) {
  ...
  try {
    await sendgrid.send({
      to: "mzuniga@starcargoservice.com", // Your email where you'll receive emails
      from: "no-reply@starcargoservice.com", // your website email address here
      subject: `[Contacto de Sitio Web]`,
...
table, td { color: #000000; } @media (max-width: 480px) { #u_content_image_7 .v-src-width { width: auto !important; } #u_content_image_7 .v-src-max-width { max-width: 31% !important; } #u_content_heading_1 .v-container-padding-padding { padding: 30px 10px !important; } #u_content_heading_1 .v-font-size { font-size: 28px !important; } #u_content_text_1 .v-container-padding-padding { padding: 30px 10px 0px !important; } #u_content_text_8 .v-container-padding-padding { padding: 30px 10px !important; } }
    </style>
...
<table id="u_content_heading_1" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <h1 class="v-font-size" style="margin: 0px; line-height: 130%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: Arvo; font-size: 35px;"><strong>Contacto de Sitio Web</strong></h1>
...
<table id="u_content_text_1" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  <tbody>
    <tr>
      <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:40px 50px 30px;font-family:'Raleway',sans-serif;" align="left">
        <div style="line-height: 140%; text-align: justify; word-wrap: break-word;">
          <p style="line-height: 140%; font-size: 14px;"><span style="font-family: 'Open Sans', sans-serif; font-size: 16px; line-height: 22.4px;">
            <strong>Correo: </strong></span>${req.body.email}
          </p>
        </div>
      </td>
    </tr>
    ...
    <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:40px 50px 30px;font-family:'Raleway',sans-serif;" align="left">
      <div style="line-height: 140%; text-align: justify; word-wrap: break-word;">
        <p style="line-height: 140%; font-size: 14px;"><span style="font-family: 'Open Sans', sans-serif; font-size: 16px; line-height: 22.4px;">
          <strong>Nombre: </strong></span> ${req.body.name}
        </p>
      </div>
    </td>
  </tr>
  ...
  <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:40px 50px 30px;font-family:'Raleway',sans-serif;" align="left">
    <div style="line-height: 140%; text-align: justify; word-wrap: break-word;">
      <p style="line-height: 140%; font-size: 14px;"><span style="font-family: 'Open Sans', sans-serif; font-size: 16px; line-height: 22.4px;">
        <strong>Compañia: </strong></span> ${req.body.company}
      </p>
    </div>
  </td>
</tr>
...
<td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:40px 50px 30px;font-family:'Raleway',sans-serif;" align="left">
  <div style="line-height: 140%; text-align: justify; word-wrap: break-word;">
    <p style="line-height: 140%; font-size: 14px;"><span style="font-family: 'Open Sans', sans-serif; font-size: 16px; line-height: 22.4px;">
      <strong>Telefono:</strong></span> ${req.body.phone}
    </p>
  </div>
</td>
</tr>
...
<td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:40px 50px 30px;font-family:'Raleway',sans-serif;" align="left">
  <div style="line-height: 140%; text-align: justify; word-wrap: break-word;">
    <p style="line-height: 140%; font-size: 14px;"><span style="font-family: 'Open Sans', sans-serif; font-size: 16px; line-height: 22.4px;">
      <strong>Mensaje: </strong></span> ${req.body.message}
    </p>
  </div>
</td>
</tr>
